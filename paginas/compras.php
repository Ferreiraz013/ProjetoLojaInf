...
// Recebe pelo GET o produto escolhido na página de produtos.
$produtoEscolhido = $_GET['produto'] ?? 'notebook-pro';

// O switch identifica o produto e define seus dados.
            ...
            <section class="area-central">
                <div class="checkout">
                    <div class="resumo-compra">
                        ...
                        <div class="linha-preco"><span>Valor do produto</span><strong>R$ <?php echo number_format($valorProduto, 2, ',', '.'); ?></strong></div>
                    </div>
                    <div class="pagamento">
                        <h3>Escolha a forma de pagamento</h3>
                        <p class="texto-suave">Selecione uma opção para continuar.</p>
                        <div class="opcoes-pagamento">
                            <a href="cartao.php?produto=<?php echo urlencode($produtoEscolhido); ?>" class="opcao-pagamento"><span class="icone-pagamento">▣</span>
                                <div><strong>Cartão</strong><small>Crédito ou débito</small></div><span>→</span>
                            </a>
                            <a href="pix.php?produto=<?php echo urlencode($produtoEscolhido); ?>" class="opcao-pagamento"><span class="icone-pagamento">◈</span>
